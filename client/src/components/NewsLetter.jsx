...
const NewsLetter = () => {
    return (
        <div className={'flex flex-col items-center justify-center text-center spcae-y-2 my-32'}>
            <h2 className={'md:text-4xl text-2xl font-semibold'}>Never Miss A blog</h2>
            <p className={'md:text-lg text-gray-500/70 pb-8'}>Subscribe to get the Latest Updates</p>
